...
def display_topics_and_number_of_questions(topics_and_number_of_questions): 
    """ Displays a list of topics to the user """
...
def request_valid_topic(topics_and_number_of_questions):   # pass in data 
    # Asks the user for a valid topic
...
def request_number_of_questions( user_topic ): 
    # Asks the user for the number of questions they would like
    topics_and_number_of_questions = quiz.get_topics_and_number_of_questions()
    while True:
...
def display_question(question):   # name?? 
    # Prints the question information and answers in random order
